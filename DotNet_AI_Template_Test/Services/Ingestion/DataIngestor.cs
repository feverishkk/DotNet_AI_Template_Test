...
namespace DotNet_AI_Template_Test.Services.Ingestion;
    ...
    IngestionCacheDbContext ingestionCacheDb)
{
    ...
    {
        var vectorCollection = vectorStore.GetCollection<string, SemanticSearchRecord>("data-dotnet_ai_template_test-ingested");
